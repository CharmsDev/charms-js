/**
 * Test script to demonstrate how to use the Charms SDK as an imported package
 */

// In a real project, you would import from the installed package:
// const { decodeTransaction, decodeDetailedCharms, hasCharmsData, emptyCharmsResult } = require('charms-sdk');
...
function testSdk() {
  console.log('Testing Charms SDK...');
  console.log('---------------------------------------------');
